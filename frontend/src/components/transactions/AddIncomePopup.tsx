        ...
        >
          {filteredSuggestions.map((suggestion, index) => (
            <button
              ...
              className={`w-full text-left px-3 py-2.5 sm:py-2 text-sm hover:bg-green-50 transition-colors ${
        ...
        <div className="flex flex-wrap gap-1.5 mt-2">
          {selectedItems.map((item, index) => (
            <button
              ...
              className="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-full text-xs transition-colors hover:opacity-75 bg-green-100 text-green-700 hover:bg-green-200 min-h-[32px] touch-manipulation"
            >
              <Tag size={10} />
...
const AddIncomePopup: React.FC<IncomeProps> = ({
          ...
          <div className="space-y-4 sm:space-y-3">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 sm:px-3 py-3 sm:py-2.5 border border-green-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all bg-green-50/50 shadow-sm text-base sm:text-sm"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-2">
              <div className="sm:col-span-1">
                ...
                <div className="relative">
                  <DollarSign
                    size={16}
                    className="absolute left-3 sm:left-2.5 top-1/2 transform -translate-y-1/2 text-green-400"
                  />
                  <input
                    type="text"
                    className="w-full pl-10 sm:pl-8 pr-4 sm:pr-3 py-3 sm:py-2.5 border border-green-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all bg-green-50/50 shadow-sm font-medium text-base sm:text-sm"
                    placeholder="0.00"
                    value={amountString}
                    onChange={(e) => {
                      const value = e.target.value;
              ...
              <div className="sm:col-span-1">
                ...
                <div className="relative" ref={currencyRef}>
                  <button
                    ...
                    className="w-full p-3 sm:p-2.5 border border-green-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent text-left flex items-center justify-between bg-green-50/50 shadow-sm transition-all disabled:opacity-50 text-base sm:text-sm touch-manipulation"
                  >
                    <span>
                    ...
                    >
                      {availableCurrencies.map((currency) => (
                        <button
                          ...
                          className={`w-full text-left px-4 sm:px-3 py-3 sm:py-2 hover:bg-green-50 transition-colors text-base sm:text-sm touch-manipulation ${
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-4 sm:px-3 py-3 sm:py-2.5 border border-green-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all bg-green-50/50 shadow-sm text-base sm:text-sm resize-none"
            ...
            <div>
              <div className="flex items-center justify-between mb-3 sm:mb-1">
                ...
                <motion.button
                  ...
                  className="flex items-center gap-1.5 sm:gap-1 px-3 py-2 sm:px-2 sm:py-1 bg-green-600 text-white text-sm sm:text-xs rounded-lg hover:bg-green-700 transition-colors shadow-sm touch-manipulation"
                ...
                {aiSuggestionsLoading && (
                  <div className="flex items-center justify-center p-5 sm:p-4 bg-purple-50 rounded-xl border border-purple-200">
                    ...
                    <span className="text-base sm:text-sm text-purple-700">
                      AI is analyzing your income for the best categories...
                    </span>
                  </div>
                )}
        ...
        return (
          <div className="space-y-5 sm:space-y-4">
            ...
            <div>
              ...
              {accountsLoading ? (
                ...
                <>
                  ...
                  />
                  {selectedAccount && (
                    <div className="mt-3 sm:mt-2 p-3 sm:p-2 bg-green-50 border border-green-200 rounded-xl shadow-sm">
                      <div className="flex items-center justify-between">
                        <div className="min-w-0 flex-1">
                          <div className="font-medium text-green-800 text-base sm:text-sm truncate">
                        ...
                        <button
                          ...
                          className="text-green-500 hover:text-green-700 transition-colors p-1 touch-manipulation"
                        >
            ...
            {selectedAccount && (
              <div className="space-y-4 sm:space-y-3">
                {/* Income Summary */}
                <div className="p-4 sm:p-3 bg-green-50/80 backdrop-blur-sm border border-green-200/50 rounded-xl shadow-sm">
                  <h3 className="font-semibold text-lg sm:text-base mb-3 sm:mb-2 text-green-800">
                    {formData.name}
                  </h3>
                  ...
                  {formData.description && (
                    <div className="mt-3 sm:mt-2 pt-3 sm:pt-2 border-t border-green-200">
                    ...
                    <div className="mt-3 sm:mt-2 pt-3 sm:pt-2 border-t border-green-200">
                      ...
                      <div className="flex flex-wrap gap-1.5 sm:gap-1 mt-2 sm:mt-1">
                        {selectedCategoryNames.map((categoryName, index) => (
                          <span
                            key={index}
                            className="px-2.5 py-1 sm:px-1.5 sm:py-0.5 bg-green-100 text-green-700 text-sm sm:text-xs rounded"
                          >
                            {categoryName}
                          </span>
                        ))}
                ...
                {/* Transaction Summary */}
                {formData.amount > 0 && (
                  <div className="p-4 sm:p-3 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-100 rounded-xl shadow-sm">
                    <h3 className="font-bold text-green-700 mb-3 sm:mb-2 flex items-center text-base sm:text-sm">
                      ...
                      <div className="bg-white rounded-lg border border-green-100 shadow-sm overflow-hidden">
                        <div className="grid grid-cols-1 divide-y divide-green-50">
                          ...
                          <div className="p-3 sm:p-2 flex justify-between items-center">
                            ...
                            <span className="text-green-500 font-medium text-base sm:text-sm">
                              +{getTransactionAmount().toFixed(2)}{" "}
                              {selectedAccount.currency}
                            </span>
                          </div>
                          <div className="p-3 sm:p-2 flex justify-between items-center bg-green-50/50">
                    ...
                    {formData.currency !== selectedAccount.currency &&
                      ...
                      !fetchingRates && (
                        <div className="mt-3 sm:mt-2 text-sm sm:text-xs">
                          <div className="flex items-center text-green-700 mb-2 sm:mb-1">
                          ...
                          <div className="flex items-center justify-between gap-2">
                            <div className="px-3 py-2 sm:px-2 sm:py-1 bg-white rounded-lg border border-green-200 text-green-900 text-center">
                            ...
                            <div className="px-3 py-2 sm:px-2 sm:py-1 bg-green-500 text-white rounded-lg shadow-md text-center">
                              <p className="text-sm sm:text-xs font-medium">
                          ...
                          <div className="text-sm sm:text-xs mt-2 sm:mt-1 text-green-600 border-t border-green-100 pt-2 sm:pt-1">
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4">
      ...
      >
        {/* Enhanced Header */}
        <div className="bg-gradient-to-r from-green-600 to-green-800 relative overflow-hidden flex-shrink-0">
