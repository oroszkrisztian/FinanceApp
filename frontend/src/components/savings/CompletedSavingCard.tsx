    ...
    >
      ...
      <div className="relative">
        ...
        <div className="mt-5 flex gap-2">
          <button
            onClick={() => onDelete(account.id, account.name)}
            className="flex-1 py-2.5 px-4 bg-red-50 text-red-700 rounded-lg hover:bg-red-100 focus:ring-2 focus:ring-red-500 focus:ring-opacity-50 focus:outline-none transition-all duration-200 text-sm font-medium flex items-center justify-center gap-1.5"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-4 w-4"
