...
function CartesianProvider(props) {
  ...
  const xValues = React57.useMemo(() => computeAxisValue({
    drawingArea,
    formattedSeries,
    axis: xAxis,
  ...
  const yValues = React57.useMemo(() => computeAxisValue({
    drawingArea,
    formattedSeries,
    axis: yAxis,
...
function HighlightedProvider({
  ...
  const series = useSeries();
  const seriesById = React61.useMemo(() => {
  ...
  const providerValue = React61.useMemo(() => {
    return {
      isInitialized: true,
      data: {
        highlightScope,
...
function useHighlighted() {
  const {
    isInitialized,
    data
  } = React62.useContext(HighlightedContext);
  if (!isInitialized) {
...
var ZAxisContext = React63.createContext({
  zAxis: {},
  zAxisIds: []
});
if (true) {
...
function ZAxisContextProvider(props) {
  ...
  const zAxis = React63.useMemo(() => inZAxis == null ? void 0 : inZAxis.map((axisConfig) => {
...
function BarLabelPlot(props) {
  ...
  return (0, import_jsx_runtime29.jsx)(React72.Fragment, {
...
var AnimationContext = React73.createContext({
  isInitialized: false,
  data: {
...
function AnimationProvider(props) {
  ...
  const [skipAnimation2, setSkipAnimation] = React74.useState(isAnimationDisabledEnvironment || void 0);
  useIsomorphicLayoutEffect(() => {
    var _a;
...
function useSkipAnimation(skipAnimation2) {
  const {
    isInitialized,
    data
  } = React75.useContext(AnimationContext);
  if (!isInitialized) {
...
function BarPlot(props) {
  ...
  return (0, import_jsx_runtime31.jsxs)(React76.Fragment, {
...
var useAxisEvents = (disableAxisListener) => {
  ...
  const {
    dispatch
  } = React77.useContext(InteractionContext);
  const usedXAxis = xAxisIds[0];
  const usedYAxis = yAxisIds[0];
  const mousePosition = React77.useRef({
    isInChart: false,
    x: -1,
    y: -1
  });
...
var ChartsSurface = React78.forwardRef(function ChartsSurface2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiChartsSurface"
  });
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime33.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime33.jsxs)(React79.Fragment, {
...
function useChartGradient() {
  const {
    chartId
  } = React81.useContext(DrawingContext);
  return React81.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
...
var useDefaultizeAxis = (inXAxis, inYAxis, dataset) => {
  const xAxis = React82.useMemo(() => defaultizeAxis(inXAxis, dataset, "x"), [inXAxis, dataset]);
  const yAxis = React82.useMemo(() => defaultizeAxis(inYAxis, dataset, "y"), [inYAxis, dataset]);
  return [xAxis, yAxis];
};
...
var ChartContainer = React84.forwardRef(function ChartContainer2(props, ref) {
  const {
    children,
    drawingProviderProps,
    seriesProviderProps,
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime41.jsxs)(React91.Fragment, {
...
var Portal = React92.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React92.isValidElement(children) ? getReactElementRef(children) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    ...
    return (0, import_jsx_runtime42.jsx)(React92.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime42.jsx)(React92.Fragment, {
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime48.jsx)(React98.Fragment, {
...
function LegendPerItem(props) {
  ...
  const theme = useTheme5();
  const drawingArea = useDrawingArea();
  const labelStyle = React109.useMemo(
  ...
  const padding2 = React109.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React109.useCallback((label, inStyle = {}) => {
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React109.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  const gapX = React109.useMemo(() => {
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime59.jsxs)(React113.Fragment, {
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime61.jsxs)(React115.Fragment, {
...
function ChartsGridVertical(props) {
  ...
  return (0, import_jsx_runtime63.jsx)(React117.Fragment, {
    children: xTicks.map(({
      formattedValue,
      offset: offset2
...
function ChartsGridHorizontal(props) {
  ...
  return (0, import_jsx_runtime64.jsx)(React118.Fragment, {
    children: yTicks.map(({
      formattedValue,
      offset: offset2
...
function ChartsOnAxisClickHandler(props) {
  ...
  const {
    axis
  } = React120.useContext(InteractionContext);
  const {
    xAxisIds,
    xAxis,
    yAxisIds,
  ...
  return (0, import_jsx_runtime66.jsx)(React120.Fragment, {});
}
...
var BarChart = React124.forwardRef(function BarChart2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiBarChart"
  });
